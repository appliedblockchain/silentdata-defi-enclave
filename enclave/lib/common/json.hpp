...
public:
    ...
    {
        if (!hasKey(key))
            THROW_EXCEPTION(kJSONKeyError, "Object does not have key: " + key);
        return operator[](key);
    }
    ...
    string String() const
    {
        if (Type != Class::String)
            THROW_EXCEPTION(kJSONTypeError, "Value is not a string");
    ...
    double Float() const
    {
        if (Type == Class::Null)
            ...
            THROW_EXCEPTION(kJSONTypeError, "Value is not a float");
    ...
    long Int() const
    {
        if (Type == Class::Null)
            ...
            THROW_EXCEPTION(kJSONTypeError, "Value is not an integer");
        return Internal.Int;
    }
    long ToInt() const
    {
    ...
    bool IsNumber() const { return (Type == Class::Floating || Type == Class::Integral); }
    double Number() const
    {
        if (Type == Class::Null)
        {
        ...
        {
            if (std::abs(Internal.Int) > CORE_MAX_SAFE_INTEGER)
                THROW_EXCEPTION(kIntegerOverflow, "Integer too large to cast to double");
            return static_cast<double>(Internal.Int);
        }
        THROW_EXCEPTION(kJSONTypeError, "Value is not a float or integer");
    }
    ...
    bool Bool() const
    {
        if (Type == Class::Null)
            ...
            THROW_EXCEPTION(kJSONTypeError, "Value is not a boolean");
    ...
    JSONWrapper<map<string, JSON>> ObjectRange()
    {
        ...
        THROW_EXCEPTION(kJSONTypeError, "JSON type not an object");
    }
    ...
    JSONWrapper<deque<JSON>> ArrayRange()
    {
        ...
        THROW_EXCEPTION(kJSONTypeError, "JSON type not an array");
    }
