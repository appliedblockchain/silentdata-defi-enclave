 ...
 * time-constant way.
 */
static void memselect(void *out, const void *pa, const void *pb, size_t max, int flag)
{
 ...
 */
static void ed_add(struct ed *out, const struct ed *P, const struct ed *Q)
{
 ...
 */
static void ed_double(struct ed *out, const struct ed *P)
{
 ...
 */
static void ed_sub(struct ed *out, const struct ed *P, const struct ed *Q)
{
    fld_t a, b, c, d, e, f, g, h, t;
 ...
 */
static void ed_add_pc(struct ed *out, const struct ed *P, const struct pced *Q)
{
    fld_t a, b, c, d, e, f, g, h;
 ...
 */
static void ed_sub_pc(struct ed *out, const struct ed *P, const struct pced *Q)
{
    fld_t a, b, c, d, e, f, g, h;
 ...
 *   2 | pow
 */
static void scale16(struct pced *out, int pow, int x)
{
    struct pced R = {{0}, {0}, {0}};
    limb_t mA, mB, mask;
    int neg, sgnx, absx;
 ...
 */
void ed_scale_base(struct ed *out, const sc_t x)
{
    struct ed R0, R1;
    struct pced P;
    sc_t tmp;
 ...
 */
static void ed_precompute(struct pced *R, const struct ed *P)
{
 ...
 */
void ed_dual_scale(struct ed *R, const sc_t x, const sc_t y, const struct ed *Q)
{
    struct ed QpB, QmB;
    struct pced pcQ;
