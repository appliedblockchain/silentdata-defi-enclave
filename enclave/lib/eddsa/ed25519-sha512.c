...
static void ed25519_key_setup(uint8_t out[SHA512_HASH_LENGTH], const uint8_t sk[ED25519_KEY_LEN])
{
    struct sha512 hash;
 ...
 */
static void genpub(uint8_t pub[ED25519_KEY_LEN], const uint8_t sec[ED25519_KEY_LEN])
{
 ...
 */
bool ed25519_verify(const uint8_t sig[ED25519_SIG_LEN],
 ...
 */
static void conv_sk_ed25519_to_x25519(uint8_t out[X25519_KEY_LEN],
 ...
 *
 */
bool eddsa_verify(const uint8_t sig[ED25519_SIG_LEN],
                  const uint8_t pub[ED25519_KEY_LEN],
                  const uint8_t *data,
                  size_t len)
{
 ...
 * (obsolete interface!)
 */
void eddsa_pk_eddsa_to_dh(uint8_t out[X25519_KEY_LEN], const uint8_t in[ED25519_KEY_LEN])
{
 ...
 * (obsolete interface!)
 */
void eddsa_sk_eddsa_to_dh(uint8_t out[X25519_KEY_LEN], const uint8_t in[ED25519_KEY_LEN])
{
    conv_sk_ed25519_to_x25519(out, in);
    burnstack(1024);
}
